...
public class ConsoleProgram {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Error in program. Make sure you extend ConsoleProgram1");
        } catch (InstantiationException ex) {
            System.out.println("Error in program. Make sure you extend ConsoleProgram2");
        } catch (ClassNotFoundException ex) {
            System.out.println("Error in program. Make sure you extend ConsoleProgram3");
        }
    }
